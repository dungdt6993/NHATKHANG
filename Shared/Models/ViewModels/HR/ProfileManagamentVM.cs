...
{
    public class ProfileManagamentVM : Profile, Staff, JobHistory, SalaryHistory, Division, Department, DepartmentGroup, Position, PositionGroup, Section, Country, Ethnic, Shift, ContractType, WorkType, PermissionUser, JobSalHistory, AdjustProfile, Rank
    {
        //Para
