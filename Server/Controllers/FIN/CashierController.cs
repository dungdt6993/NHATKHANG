    ...
    public class CashierController : ControllerBase
    {
        ...
        public async Task<ActionResult<bool>> OpenRoomTable(ArrayList _arrayList)
        {
            ...
            using (var conn = new SqlConnection(_connConfig.Value))
            {
                ...
                else
                {
                    ...
                    await conn.ExecuteAsync(sql, new { _invoiceVM.CheckNo, _filterPosVM.RoomTableID, ChangeRoomTableBy = _filterPosVM.UserID });
                }
        ...
        public async Task<ActionResult<bool>> UpdateInvoiceDetail(InvoiceVM _invoiceDetail)
        {
            using (var conn = new SqlConnection(_connConfig.Value))
            {
                ...
                {
                    _invoiceDetail.Seq,
                    _invoiceDetail.CheckNo,
                    _invoiceDetail.Qty,
                    _invoiceDetail.Price,
                    _invoiceDetail.INote,
                    _invoiceDetail.Items_DiscountPrice,
                    _invoiceDetail.Items_DiscountPercent
                });
        ...
        public async Task<ActionResult<bool>> UpdateInvoiceDiscount(InvoiceVM _invoiceDetail)
        {
            using (var conn = new SqlConnection(_connConfig.Value))
            {
                ...
                {
                    _invoiceDetail.CheckNo,
                    _invoiceDetail.Invoice_DiscountPrice,
                    _invoiceDetail.Invoice_DiscountPercent
                });
